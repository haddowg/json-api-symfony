...
use haddowg\JsonApi\Schema\Pagination\FixedCursorBasedPaginationLinkProviderTrait;
use haddowg\JsonApi\Schema\Pagination\PaginationLinkProviderInterface;

final class StubFixedCursorBasedPaginationProvider implements PaginationLinkProviderInterface
{
