...
use haddowg\JsonApi\Tests\Double\StubFixedPageBasedPaginationProvider;
use PHPUnit\Framework\Attributes\Group;
use PHPUnit\Framework\Attributes\Test;
use PHPUnit\Framework\TestCase;

final class FixedPageBasedPaginationLinkProviderTraitTest extends TestCase
{
    #[Test]
    ...
    public function getSelfLinkWhenPathIsProvided(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=1', $link->href);
    }
    ...
    public function getSelfLinkWhenPathAndAdditionalQueryStringIsProvided(): void
    {
        ...
        self::assertNotNull($link);
        self::assertSame('https://example.com/api/users?a=c&b=d&page%5Bnumber%5D=1', $link->href);
    }
    ...
    public function getSelfLinkWhenPathWithQueryStringIsProvided(): void
    {
        ...
        self::assertNotNull($link);
        self::assertSame('https://example.com/api/users?a=b&page%5Bnumber%5D=1', $link->href);
    }
    ...
    public function getLastLink(): void
    {
        ...
        self::assertNotNull($link);
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=5', $link->href);
    }
    ...
    public function getPrevLinkWhenPageIsLast(): void
    {
        ...
        self::assertNotNull($link);
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=4', $link->href);
    }
    ...
    public function getNextLink(): void
    {
        ...
        self::assertNotNull($link);
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=3', $link->href);
    }
