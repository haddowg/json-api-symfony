 ...
 * JSON:API document, so it declares `outputMeta: true`. The generated document
 * advertises a `200` referencing the shared `MetaDocument` component instead of a
 * products resource body, and the component itself joins the schema set — proving the
 * bundle wires `outputMeta` through the descriptor to core's projection.
 */
#[AsJsonApiAction(
    type: 'products',
    path: 'summarize',
