 ...
 * {@see IdentifierMetaArticleResource} (a parent-aware `identifierMeta()` on the
 * `author` and `comments` relations) over the canonical fixtures, with the
 * `articles`/`authors`/`comments` providers wired from {@see ArticleProviderFactory}.
 * Distinct cache/project dirs keep its compiled container from colliding with the
 * other kernels'.
 */
final class IdentifierMetaInMemoryTestKernel extends Kernel
{
    ...
    {
        $dir = \sys_get_temp_dir() . '/json-api-symfony-tests/identifier-meta-app';
    ...
    {
        return \sys_get_temp_dir() . '/json-api-symfony-tests/identifier-meta-cache/' . $this->environment;
    }

    public function getLogDir(): string
    {
        return \sys_get_temp_dir() . '/json-api-symfony-tests/identifier-meta-log';
    }
    ...
    protected function configureContainer(ContainerConfigurator $container, LoaderInterface $loader, ContainerBuilder $builder): void
    {
        ...
        $services->set(IdentifierMetaArticleResource::class);
