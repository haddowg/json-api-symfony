...
#[Group('spec:crud')]
final class AddToRelationshipOperationTest extends TestCase
{
    #[Test]
    public function exposesItsConstructorArgumentsIncludingTheBody(): void
    {
        ...
        $operation = new AddToRelationshipOperation($target, $query, $context, $body);
    ...
    {
        self::assertTrue((new \ReflectionClass(AddToRelationshipOperation::class))->isReadOnly());
    }
}
