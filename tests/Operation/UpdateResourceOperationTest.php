...
#[Group('spec:crud')]
final class UpdateResourceOperationTest extends TestCase
{
    #[Test]
    public function exposesItsConstructorArgumentsIncludingTheBody(): void
    {
        ...
        $operation = new UpdateResourceOperation($target, $query, $context, $body);
    ...
    {
        self::assertTrue((new \ReflectionClass(UpdateResourceOperation::class))->isReadOnly());
    }
}
