...
final class FetchRelationshipOperationTest extends TestCase
{
    #[Test]
    public function exposesItsConstructorArguments(): void
    {
        ...
        $operation = new FetchRelationshipOperation($target, $query, $context);
    ...
    {
        self::assertTrue((new \ReflectionClass(FetchRelationshipOperation::class))->isReadOnly());
    }
}
