...
#[Group('spec:crud')]
final class UpdateRelationshipOperationTest extends TestCase
{
    #[Test]
    public function exposesItsConstructorArgumentsIncludingTheBody(): void
    {
        ...
        $operation = new UpdateRelationshipOperation($target, $query, $context, $body);
    ...
    {
        self::assertTrue((new \ReflectionClass(UpdateRelationshipOperation::class))->isReadOnly());
    }
}
