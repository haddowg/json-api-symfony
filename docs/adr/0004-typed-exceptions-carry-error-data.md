...
Errors are modelled as a typed exception hierarchy — a `JsonApiExceptionInterface`
...
lets a single error-handling middleware render any thrown `JsonApiExceptionInterface`
